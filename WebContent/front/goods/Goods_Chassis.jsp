				...
				<ul class="nav" id="main-menu">
					...
					<li><a href="${pageContext.request.contextPath}/fyhGoods?op=queryGoodsByPage" ><i
						...
						<ul class="nav nav-second-level">						
							...
							<li><a href="${pageContext.request.contextPath}/fyhGoods?op=queryGoodsByGoodsTypeId&goodsTypeId=2" >制动系统</a></li>
							...
							<li><a href="${pageContext.request.contextPath}/fyhGoods?op=queryGoodsByGoodsTypeId&goodsTypeId=5" class="active-menu">底盘及转向系统</a></li>
						</ul>
						</li>
				</ul>
